...
public class DummyContainerService extends AbstractContainerService {

  public DummyContainerService(Configuration conf) {
    super(conf);
  }
  ...
  public void setMyCallBack(ContainerService callback) {
