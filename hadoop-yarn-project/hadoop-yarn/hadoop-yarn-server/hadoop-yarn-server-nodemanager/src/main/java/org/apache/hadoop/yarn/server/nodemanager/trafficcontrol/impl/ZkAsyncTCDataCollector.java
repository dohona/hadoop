...
/**
 * Retrieve connection data from ZooKeeper storage and immediately report them
 * to {@link TrafficController}.
 *
 */
public class ZkAsyncTCDataCollector extends AbstractAsyncTCDataCollector {

  static final Log LOG = LogFactory.getLog(ZkAsyncTCDataCollector.class);
  ...
  public ZkAsyncTCDataCollector(Configuration conf) {
    super(conf);
